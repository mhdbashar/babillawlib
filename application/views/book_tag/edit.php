    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Book Tag Edit</h3>
            </div>
			<?php echo form_open('book_tag/edit/'.$book_tag['book_tag_id']); ?>
			<div class="box-body">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="book_id" class="form-control">
								...
								{
									$selected = ($book['book_id'] == $book_tag['book_id']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="tag_id" class="form-control">
								...
								{
									$selected = ($tag['tag_id'] == $book_tag['tag_id']) ? ' selected="selected"' : "";
